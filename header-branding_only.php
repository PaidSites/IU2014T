...
<!-- Run jquery email validation script -->
<script type="text/javascript" src="template/scripts/email-validation.js"></script>
...
<script type="text/javascript" src="//use.typekit.net/wjh3dze.js"></script>
	...
	<div class="header-bg"><div class="container">
    	...
    	<div class="row">
            ...
            <div id="branding" class="col-sm-12">
                ...
                <a href="http://investmentu.com/" target="_blank"><img src="<?php echo $logo_URL ?>" class="img-responsive" alt="Investment U"></a>
